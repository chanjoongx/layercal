...
export default function LayerCal() {
  ...
  const addLayersFromAdvisor = useCallback((layerConfigs) => {
    ...
    setModelLayers(prev => [...prev, ...newLayers]);
  ...
  return (
    <div className={`min-h-screen transition-colors duration-200 ${
      ...
      <div className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-7xl">
        ...
        {/* AI Architecture Advisor Modal — NEW */}
        {showAdvisorModal && (
          <AIAdvisor
        ...
        <div className={`mt-6 sm:mt-8 text-center text-xs sm:text-sm space-y-1 ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
          ...
          <p className="text-[10px] sm:text-xs">© {new Date().getFullYear()} LayerCal · <a href="https://github.com/chanjoongx/layercal" target="_blank" rel="noopener noreferrer" className="underline hover:text-purple-400">GitHub</a></p>
        </div>
      </div>
    </div>
  );
